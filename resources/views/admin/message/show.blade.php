                                    ...
                                    <div class="flex flex-wrap ">
                                        <div class="w-full lg:w-6/12 px-4">
                                            <div class="relative w-full mb-3">
                                                ...
                                                <p class="border-0 px-3 py-3 bg-gray-50 rounded text-sm shadow w-full ease-linear transition-all duration-150">{{ $message->name}}</p>
                                    ...
                                    <div class="flex flex-wrap">
                                        <div class="w-full lg:w-12/12 px-4">
                                            <div class="relative w-full mb-3">
                                                ...
                                                <div
                                                    class="border-0 px-3 py-3 placeholder-blueGray-300 text-blueGray-600 bg-gray-50 text-gray-500 rounded text-sm shadow focus:outline-none focus:ring w-full ease-linear transition-all duration-150">{{ $message->message }}</div>
                                            </div>
                                        </div>
                                    </div>
                                </form>
