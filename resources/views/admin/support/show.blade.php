        ...
        <div class="w-auto mx-auto">
            <div class=overflow-hidden shadow-xl">
                ...
                <section
                    ...
                    <h1 class="text-3xl font-bold text-center text-gray-800">Mostrando la pregunta de Soporte</h1>
                            ...
                            <div class="flex-auto px-4 lg:px-10 py-10 pt-0">
                                <form class="mt-8 space-y-3" action="{{ route('admin.support.store') }}" method="POST">
                                        ...
                                        <div class="w-full lg:w-6/12 px-4">
                                            <div class="relative w-full mb-3">
                                                ...
                                                <input
                                                    ...
                                                    type="text" name="title" value="{{ $support->title}}" disabled>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="flex flex-wrap">
                                        <div class="w-full lg:w-12/12 px-4">
                                            <div class="relative w-full mb-3">
                                                ...
                                                <div class="border-0 px-3 py-3 text-blueGray-600 bg-gray-50 rounded text-sm shadow">
                                                    {{$support->description}}
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    <div class="flex  gap-5 justify-center">
                                        ...
                                        <div class="flex  gap-5 justify-center">
                                            <x-buttonP href="{{ route('admin.support') }}" class="border-2 border-violet-600">Regresar</x-buttonP>
                                        </div>
