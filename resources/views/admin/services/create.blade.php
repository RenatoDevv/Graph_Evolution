        ...
        <div class="w-auto mx-auto">
            <div class=overflow-hidden shadow-xl">
                ...
                <section
                    ...
                    <h1 class="text-3xl font-bold text-center text-gray-800">Registrar Nuevo Servicio</h1>
                    <p class="text-center text-gray-500">Datos del nuevo Servicio</p>
                    <div class="bg-white p-8 rounded-md w-full">
                        <div
                            ...
                            <div class="flex-auto px-4 lg:px-10 py-10 pt-0">
                                <form class="mt-8 space-y-3" action="{{ route('admin.services.store') }}" method="POST"
                                        ...
                                        <div class="w-full lg:w-6/12 px-4">
                                            <div class="relative w-full mb-3">
                                                ...
                                                <textarea type="text" name="description"
                                                    ...
                                                    rows="2" placeholder="Descripcion de la pagina"></textarea>
                                                @error('description')
                                                    <strong>{{ $message }}</strong>
                                                @enderror
                                            </div>
                                        ...
                                        <div class="w-full lg:w-12/12 px-4">
                                            <div class="relative w-full mb-3">
                                                ...
                                                <input
                                                    ...
                                                    type="text" name="price" value="" placeholder="Precio"
                                                    required>
                                                @error('price')
                                                    <strong>{{ $message }}</strong>
                                                @enderror
