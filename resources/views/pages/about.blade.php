...
@section('content')
    ...
    <div class="about-biografi d-flex flex-col items-center content">
        <h2 class="aboout-title-b section-subtitle m-0" style="border-bottom: 3px solid white; line-heigth: 20px;">Biografia
        </h2>
