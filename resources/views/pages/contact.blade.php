...
@section('content')
    <x-app>
        <x-section-container class="contact-presentation m-auto">
            <div>
    ...
    <x-app>
        <x-section-container class="contact-socials flex flex-wrap items-center justify-center gap-3 m-auto w-full">
            <div
    ...
    <x-app>
        <x-section-container class="contact-form d-flex gap-5 max-w-4xl justify-center items-center m-auto bg-[#75757521]">
            ...
            <form class="form-ct row g-3 d-flex flex-column justify-content-center align-items-center" id="explorationForm"
                ...
                <div class="mb-3">
                    <textarea
                        class="bg-transparent w-full rounded-md border-0 py-1.8 text-gray-300 ring-1 ring-gray-700 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-pink-600 sm:text-sm"
                        placeholder="Escriba su mensaje" name="message"></textarea>
                </div>
    ...
    <x-app>
        <section class="contact-map w-full" id="location">
