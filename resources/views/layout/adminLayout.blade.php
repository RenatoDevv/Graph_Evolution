...
<body>
    <svg style="display:none;">
        <symbol id="buscar" viewBox="0 0 16 16">
            <path
        ...
        <symbol id="configuracion" viewBox="0 0 16 16">
            <path
    ...
    <header class="page-header">
        <nav>
            <a href="#0" aria-label="forecastr logo" class="logo">
                ...
                <h2 class="fw-bold">Graph <br> Evolution</h2>
            </a>
            ...
            <ul class="admin-menu p-0 mt-5 mb-0">
                ...
                <li>
                    <a href="#0">
                        <svg>
                            <use xlink:href="#configuracion"></use>
                        </svg>
                        <span>Settings</span>
                    </a>
                </li>
    ...
    <script>
        ...
        perfilL.addEventListener('click', function(event) {
            ...
            Swal.fire({
                title: 'Atenciòn',
                text: "Estas seguro de terminar su Sesion?",
                icon: 'warning',
                ...
                if (result.isConfirmed) {
                    Swal.fire(
                        'Exito!',
                        'Tu sesion a sido eliminado correctamente.',
                        'success'
                    )
                }
            })
